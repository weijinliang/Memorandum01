...
public class AddBwlActivity extends Activity{
    ...
    private TimePickerDialog.OnTimeSetListener timeSetListener=new TimePickerDialog.OnTimeSetListener() {
        ...
        public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
            ...
            timeStr.append(hourOfDay).append(":")
                    .append(minute);
    ...
    public void setAlarm(long id){
        ...
        String noticeDate=etDate.getText().toString();
        String noticTime=etTime.getText().toString();
        ...
        calendar.set(Integer.parseInt(noticeDate.split("-")[0]),
                ...
                Integer.parseInt(noticTime.split(":")[0]),
                Integer.parseInt(noticTime.split(":")[1]));
        ...
        Log.e("AmndroidBWL","setAlarm end...");
    }
}
